...
def create_spark_session():
    """
    Description: This open spark session
    """
...
def process_song_data(spark, input_data, output_data):  
    """
    Description: This function loads song_data from S3 bucket and processes it so data can be loaded to parquet file
...
def process_log_data(spark, input_data, output_data):
    """
    Description: This function loads log_data from S3 bucket and processes it so data can be loaded to parquet file
